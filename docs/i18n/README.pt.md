...
daí o Fulgoria lê sozinho todos os documentos desse tipo e devolve dados limpos (CSV). Começa
...
O Fulgoria é um satélite independente do ecossistema **[Escriba](https://github.com/diegoparras/escriba)**
...
O Fulgoria traz um **servidor leve** (`server.js`, Node/Express) que só serve o app estático e um
...
Ou use a imagem publicada no **GHCR** (`ghcr.io/diegoparras/fulgoria:latest`, construída pela CI a
